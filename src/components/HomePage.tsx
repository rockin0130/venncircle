    ...
    <div className="px-5">
      ...
      <div className="fixed bottom-28 left-4 z-50">
        <button
          ...
          className="w-11 h-11 rounded-full bg-card/90 backdrop-blur-sm border border-border shadow-md flex items-center justify-center hover:bg-secondary/80 active:scale-95 transition-all"
